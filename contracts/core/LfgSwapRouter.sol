...
import '../libraries/LfgSwapLibrary.sol';
import '../libraries/TransferHelper.sol';
import '../interface/ILfgSwapRouter.sol';
...
contract LfgSwapRouter is ILfgSwapRouter, Ownable {
    ...
    function swapExactTokensForTokens(
        ...
        require(amounts[amounts.length - 1] >= amountOutMin, 'LfgSwapRouter: INSUFFICIENT_OUTPUT_AMOUNT');
